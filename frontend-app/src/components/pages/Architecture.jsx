          ...
          <SectionCard id="robotrade-guards" icon="🛡" title="RoboTrade Execution Guards"
            ...
            <Table
              ...
              rows={[
                ...
                [<b style={{ color: 'var(--green-text)' }}>Book-Rules Diagnostic (NEW 2026-04-20)</b>,
                  <Code>per-candidate</Code>,
                  <>Ships <Code>bookRules</Code> object on every pick — diagnostic only, not a gate yet</>,
                  <>Pure rule-set distilled from Varsity M2/M9 + "How to Day Trade for a Living" (Aziz) + "Trading in the Zone" (Douglas) + "Technical Analysis of the Financial Markets" (Murphy) + "Reading Price Charts Bar by Bar" (Brooks). Eight layers: (1) <b>Regime</b> — TRENDING_UP/DOWN / SIDEWAYS / VOLATILE / NO_TRADE. (2) <b>Entry</b> — breakout + pullback predicates (vol≥1.5×, ADX≥18, RSI 40-70, R:R≥1.5, chase/late blockers). (3) <b>Exit</b> — SL=1×ATR (floor 0.5%), TP=1.5×ATR (R:R≥1.5 enforced), BE@+1R, trail@+2R with 0.75×ATR, 60-min time stop, 15:15 square-off. (4) <b>Risk</b> — 1%/trade, 2% daily loss, halve@1.5%, max 3 concurrent, max 5/day, drawdown tiers 10/15/20%. (5) <b>Rejection codes</b> — 15 hard no-trade signals. (6) <b>Psych</b> — overtrading / revenge / post-TP euphoria / lunch-block-after-2-losses. (7) <b>Quality score</b> (0-100, A+..D) — trend 30 · vol 25 · vol-quality 15 · structure 15 · MTF 15. (8) <b>Losing-pattern blocks</b> — chasing, late entry, sideways, vertical spike, thin breakout, big-gap fade, first-bar, counter-EMA-stack, round-number. (9) <b>20 non-negotiables</b> (NN01..NN20) — never trade without SL / past 15:15 / when ADX&lt;18 / when VIX&gt;25 / against daily trend / on circuit / on earnings / R:R&lt;1.5, etc. To promote to a hard gate: flip <Code>FILTERS.ENFORCE_BOOK_RULES_GATE</Code>.</>],
