            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <Table
                ...
                rows={[
                  ...
                  [<b>3</b>, <span style={{ color: '#f59e0b' }}>Strategy architecture</span>, '4 core setups (ORB+, VWAP_PULLBACK, COMPRESSION, HOLY_GRAIL — Wave 15) + short mirrors · tier classification A-list/B-list/SKIP refreshed at 9:14/11:00/13:30 IST · trend-day detection at 9:45 IST · Initial Balance day-type at 10:15 IST · pre-market routine at 8:30 IST (Gift Nifty, VIX, FII/DII, 3-day pivot)'],
                  ...
                  [<b>14</b>, <span style={{ color: '#10b981' }}>First-day-live fixes</span>, 'Auto-rerun premarket routine after /auth/callback if today\'s data is empty (root cause of 2026-05-08 zero-A-tier day) · EOD :PARTIAL duplicate-entry false positive fixed · strategy diversity ratio fixed (was 100% spuriously)'],
                  [<b>15</b>, <span style={{ color: '#f59e0b' }}>Holy Grail (4th setup)</span>, 'Linda Raschke "Holy Grail" (Street Smarts, 1996) added as 4th v2 setup. ADX > 30 strong-trend pullback to rising 20-EMA + bullish reversal candle. Documented 65–70% win rate — highest-conviction intraday setup in published literature. Distinct from VWAP_PULLBACK: anchor is 20-EMA (momentum) vs VWAP (volume-weighted institutional level). Both can fire same day. Short mirror HOLY_GRAIL_SHORT.'],
                ]}
              />
            </div>
